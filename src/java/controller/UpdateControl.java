...
public class UpdateControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String quantiity = request.getParameter("quantityEdit");
        int quantity = Integer.parseInt(quantiity);
        dao.updateProduct(name, image, price, title, description, category,quantity, ID);
