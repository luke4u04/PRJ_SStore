    ...
    <head>
                            ...
                            <div class="product col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text show_txt">Stock: ${o.quantity}</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <c:if test="${o.quantity == 0}">
                                                <h5 class="text-danger text-center">Sold out</h5>
                                            </c:if>
                                            <div class="col">
                                                <c:if test="${o.quantity != 0}">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${b.numberPage}" var="i">
                                <li class="page-item "><a class="page-link link-dark" href="page?index=${i}">${i}</a></li>
                                </c:forEach>
        ...
        <script>
            function loadMore() {
                ...
                $.ajax({
                    url: "/Project_Honya/loadMoreControl",
