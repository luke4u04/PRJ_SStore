    ...
    <body>
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        ...
                                        <form action="buyProduct">
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <dt>Stock: ${detail.quantity} </dt><br>
                        ...
                        <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                            ...
                            <div>
                                ...
                                <div class="md-form md-outline">
                                    <label for="writeReview"><h5 class="mt-4">Review Product</h5></label>
        ...
        <div class="container" style="width: 80%">
            <div class="row" style="margin-top:25px">
                ...
                <div>
                    <h2 class="text-capitalize" style="text-align:left;" id="moiNhat">Related Products</h2>
                </div>

                <div class="col-sm-12">
                    <div id="contentRelatedBooks" class="row">
                        <c:forEach items="${listRelatedProducts}" var="n">
